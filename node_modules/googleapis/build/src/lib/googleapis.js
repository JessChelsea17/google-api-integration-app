...
var AuthPlus = /** @class */ (function (_super) {
    __extends(AuthPlus, _super);
    function AuthPlus() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        // tslint:disable-next-line: variable-name
        _this.JWT = google_auth_library_1.JWT;
        // tslint:disable-next-line: variable-name
        _this.Compute = google_auth_library_1.Compute;
        // tslint:disable-next-line: variable-name
        _this.OAuth2 = google_auth_library_1.OAuth2Client;
        return _this;
    }
    return AuthPlus;
}(google_auth_library_1.GoogleAuth));
exports.AuthPlus = AuthPlus;
var GoogleApis = /** @class */ (function (_super) {
    __extends(GoogleApis, _super);
    /**
    ...
    function GoogleApis(options) {
        ...
        _this._discovery = new discovery_1.Discovery({ debug: false, includePrivate: false });
        _this.auth = new AuthPlus();
        _this._options = {};
    ...
    GoogleApis.prototype.discover = function (url, callback) {
        if (callback) {
            this.discoverAsync(url).then(function () { return callback(); }).catch(callback);
        }
        else {
            return this.discoverAsync(url);
        }
    };
    GoogleApis.prototype.discoverAsync = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var allApis;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._discovery.discoverAllAPIs(url)];
                    case 1:
                        allApis = _a.sent();
     ...
     */
    GoogleApis.prototype.discoverAPI = function (apiPath, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var endpointCreator, ep;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._discovery.discoverAPI(apiPath)];
                    case 1:
                        endpointCreator = _a.sent();
                        ep = endpointCreator(options);
                        ep.google = this; // for drive.google.transporter
                        return [2 /*return*/, Object.freeze(ep)];
                }
            });
        });
    };
