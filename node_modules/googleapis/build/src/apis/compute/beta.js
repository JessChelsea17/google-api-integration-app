...
function Compute(options) {
    ...
    self.backendBuckets = {
         ...
         * @param {compute(beta).SignedUrlKey} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    self.images =
        {
            ...
            insert: function (params, options, callback) {
                ...
                var parameters = {
                    options: Object.assign({
                        url: (rootUrl +
                            '/compute/beta/projects/{project}/global/images')
                            .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'POST'
                    }, options),
                    params: params,
    ...
    self.networks =
        {
            ...
            insert: function (params, options, callback) {
                ...
                var parameters = {
                    options: Object.assign({
                        url: (rootUrl +
                            '/compute/beta/projects/{project}/global/networks')
                            .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'POST'
                    }, options),
                    params: params,
    ...
    self.projects =
        {
            ...
            disableXpnHost: function (params, options, callback) {
                ...
                var parameters = {
                    options: Object.assign({
                        url: (rootUrl +
                            '/compute/beta/projects/{project}/disableXpnHost')
                            .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'POST'
                    }, options),
                    params: params,
            ...
            enableXpnHost: function (params, options, callback) {
                ...
                var parameters = {
                    options: Object.assign({
                        url: (rootUrl +
                            '/compute/beta/projects/{project}/enableXpnHost')
                            .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'POST'
                    }, options),
                    params: params,
            ...
            getXpnResources: function (params, options, callback) {
                ...
                var parameters = {
                    options: Object.assign({
                        url: (rootUrl +
                            '/compute/beta/projects/{project}/getXpnResources')
                            .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'GET'
                    }, options),
                    params: params,
            ...
            listXpnHosts: function (params, options, callback) {
                ...
                var parameters = {
                    options: Object.assign({
                        url: (rootUrl +
                            '/compute/beta/projects/{project}/listXpnHosts')
                            .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'POST'
                    }, options),
                    params: params,
            ...
            moveInstance: function (params, options, callback) {
                ...
                var parameters = {
                    options: Object.assign({
                        url: (rootUrl +
                            '/compute/beta/projects/{project}/moveInstance')
                            .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'POST'
                    }, options),
                    params: params,
    ...
    self.securityPolicies = {
         ...
         * @param {compute(beta).SecurityPolicyRule} params.resource Request body data
         * @param {object} [options] Optionally override request options, such as `url`, `method`, and `encoding`.
         * @param {callback} callback The callback that handles the response.
         * @return {object} Request object
         */
    ...
    self.urlMaps =
        {
            ...
            insert: function (params, options, callback) {
                ...
                var parameters = {
                    options: Object.assign({
                        url: (rootUrl +
                            '/compute/beta/projects/{project}/global/urlMaps')
                            .replace(/([^:]\/)\/+/g, '$1'),
                        method: 'POST'
                    }, options),
                    params: params,
